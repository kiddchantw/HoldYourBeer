    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-login">Login and get token</a>
                            </li>
                    ...
                    <ul id="tocify-header-beer-brands" class="tocify-header">
                <li class="tocify-item level-1" data-unique="beer-brands">
                    <a href="#beer-brands">Beer Brands</a>
                </li>
                                    <ul id="tocify-subheader-beer-brands" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="beer-brands-GETapi-brands">
                                <a href="#beer-brands-GETapi-brands">Get all brands</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-beer-tracking" class="tocify-header">
                <li class="tocify-item level-1" data-unique="beer-tracking">
                    <a href="#beer-tracking">Beer Tracking</a>
                </li>
                                    <ul id="tocify-subheader-beer-tracking" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="beer-tracking-GETapi-beers">
                                <a href="#beer-tracking-GETapi-beers">Get my tracked beers</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="beer-tracking-POSTapi-beers">
                                <a href="#beer-tracking-POSTapi-beers">Add a beer to tracking</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="beer-tracking-POSTapi-beers--id--count_actions">
                                <a href="#beer-tracking-POSTapi-beers--id--count_actions">Update tasting count</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="beer-tracking-GETapi-beers--id--tasting_logs">
                                <a href="#beer-tracking-GETapi-beers--id--tasting_logs">Get tasting history</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Password confirmation. Must match password. Example: <code>password123</code></p>
                    ...
                    <h2 id="authentication-POSTapi-login">Login and get token</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="beer-brands">Beer Brands</h1>

    <p>APIs for managing beer brands</p>

                                <h2 id="beer-brands-GETapi-brands">Get all brands</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="beer-tracking">Beer Tracking</h1>

    <p>APIs for tracking beer tastings and managing beer collections</p>

                                <h2 id="beer-tracking-GETapi-beers">Get my tracked beers</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/beers?per_page=20&amp;page=1&amp;sort=-tasted_at&amp;brand_id=1" \
    --header "Authorization: Bearer {YOUR_TOKEN_HERE}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<p>The <code>id</code> of an existing record in the brands table. Example: <code>16</code></p>
                    ...
                    <h2 id="beer-tracking-POSTapi-beers">Add a beer to tracking</h2>
...
<p>The beer style (e.g., IPA, Stout). Example: <code>Dry Stout</code></p>
                    ...
                    <h2 id="beer-tracking-POSTapi-beers--id--count_actions">Update tasting count</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/beers/1/count_actions" \
    --header "Authorization: Bearer {YOUR_TOKEN_HERE}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<p>Optional note for this tasting. Example: <code>Enjoyed at the pub with friends</code></p>
                    ...
                    <h2 id="beer-tracking-GETapi-beers--id--tasting_logs">Get tasting history</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/beers/1/tasting_logs" \
    --header "Authorization: Bearer {YOUR_TOKEN_HERE}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/beers/1/tasting_logs"
);
