...
// Check if Scribe is available (only in dev environment)
...
return [
    ...
    'description' => 'HoldYourBeer API allows users to track their beer tastings, manage beer collections, and view tasting history.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<INTRO
        Welcome to the HoldYourBeer API documentation. This API allows you to:
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'GET /api/user', // Laravel Breeze default route
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by calling the <code>POST /api/sanctum/token</code> endpoint with your email and password. The API uses Laravel Sanctum for authentication.',
    ],
